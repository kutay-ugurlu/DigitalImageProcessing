...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
[9.36000000e+03 1.12935218e-12 5.91456839e-16]
    \end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.image.AxesImage at 0x1bec5ce4730>
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{HW_1_files/HW_1_26_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{HW_1_files/HW_1_29_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.image.AxesImage at 0x1bec3fa2400>
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{HW_1_files/HW_1_32_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.image.AxesImage at 0x1bece034490>
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{HW_1_files/HW_1_36_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.image.AxesImage at 0x1bec3b0c160>
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{HW_1_files/HW_1_38_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
<ipython-input-20-83fcb38667d6>:6: RuntimeWarning: divide by zero encountered in
log10
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.image.AxesImage at 0x1becc562220>
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{HW_1_files/HW_1_40_2.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.image.AxesImage at 0x1becc6409d0>
\end{Verbatim}
\end{tcolorbox}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{HW_1_files/HW_1_42_1.png}
    \end{center}
    { \hspace*{\fill} \\}
